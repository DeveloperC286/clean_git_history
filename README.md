  ...
  clean:
    ...
    steps:
      ...
      - name: Install Clean Git history.
        run: version="v1.0.5" && wget -O - "https://github.com/DeveloperC286/clean_git_history/releases/download/${version}/x86_64-unknown-linux-musl.tar.gz" | tar xz --directory "/usr/bin/"
...
clean-git-history-checking:
  ...
  image: rust
  before_script:
    - version="v1.0.5" && wget -O - "https://github.com/DeveloperC286/clean_git_history/releases/download/${version}/x86_64-unknown-linux-musl.tar.gz" | tar xz --directory "/usr/bin/"
  script:
...
<!-- x-release-please-start-version -->
```sh
cargo install clean_git_history --version "1.0.5"
```
<!-- x-release-please-end -->
