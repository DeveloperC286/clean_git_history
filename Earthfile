...
rust-base:
    FROM rust:1.84.1-alpine3.20@sha256:5b65959f00c8fcc9bfabb76644c4eefa0b97f8af37040dd163592536dbd6e107
...
golang-base:
    FROM golang:1.24.0@sha256:4546829ecda4404596cf5c9d8936488283910a3564ffc8fe4f32b33ddaeff239
    WORKDIR "/clean_git_history"
...
static-binary-test:
    ...
    RUN ./target/debug/clean_git_history --help
