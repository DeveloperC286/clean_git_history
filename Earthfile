...
check-clean-git-history:
    FROM +rust-base
    # renovate: datasource=github-releases depName=clean_git_history packageName=DeveloperC286/clean_git_history
    RUN cargo install clean_git_history --version v0.2.0 --locked
    DO +COPY_METADATA
